...
@customElement(`calendar-event-tracker-pattern-editor`)
class CalendarEventTrackerPatternEditor extends LitElement {
  @property({ attribute: false }) public hass?: HomeAssistant;

  @state() protected pattern?: CalendarEventTrackerConfig['pattern'];
...
export {
  CalendarEventTrackerPatternEditor
};
